...
class Motors_c {
  ...
  public:
    ...
    void setPWM( float left_pwr, float right_pwr ) {
      ...
      if (left_pwr < 0) {
        left_pwr = -left_pwr; //abs(left_pwr)
      }
      else if (left_pwr > MAX_PWM) {
        left_pwr = MAX_PWM;
      }
...
//    void rotation_for_calibration(){
//      long int duration_ms = millis();
//      setPWM(-30, 30);
//      while(millis() - duration_ms > 2000){
//        setPWM(0, 0);
//      }
//    }
